...
df_bbg = pd.read_excel(r'dadosbbg.xlsm', usecols=['NM_TICKER', 'DATA', 'NM_FIELD', 'VL_FIELD'], sheet_name='netinc') # quero especificar as colunas que eh para pegar
...
df_auxiliarbbg = pd.read_excel(r'auxiliarbbg.xlsx')
